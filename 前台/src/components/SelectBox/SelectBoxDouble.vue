...
<template>
  <div>
     <div style="width:120px;" class="selectNew__root" @click="handleClick">
        <div class="selectNew__root__title">
          {{theValue}}
        </div>
        <i class="iconfont icon-xialajiantou"></i>
        <ul class="selectNew__root__ul"  :style="{height:ulHeight+'px'}">
          <li 
    ...
    <div style="width:120px;margin-left:20px" class="selectNew__root" @click="handleClick">
        <div class="selectNew__root__title">
          {{theValue}}
        </div>
        <i class="iconfont icon-xialajiantou"></i>
