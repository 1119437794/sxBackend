<script>
    ...
    * */
     ...
     export default {
         ...
         watch: {
             getYMD () {
                 this.$emit('callback', [this.currentYear, this.currentMonth, this.currentDay])
             },
             defaultDate () {
    ...
    <div class="date_root" ref="date_root">
        ...
        <div v-show="show" class="date_calender">
            <ul class="date_act">
                ...
                <li class="date_actYear" v-text="currentYear" @click="getYearList(-1)"></li>
                <li >/</li>
                <li class="date_actMonth" v-text="currentMonth" @click="getMonthList"></li>
                <template v-if="isShowDay">
                    <li>/</li>
                    <li class="date_actDay" v-text="currentDay" @click="getDaysList"></li>
                </template>
